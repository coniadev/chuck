...
test('Endpoint with defaults', function () {
    $router = new Router();
    $router->endpoint('/endpoints', TestEndpoint::class, 'id')->add();
...
test('Endpoint with plural/singular', function () {
    $router = new Router();
    $router->endpoint(['/endpoints', '/endpoint'], TestEndpoint::class, 'id')->add();
...
test('Endpoint with name', function () {
    $router = new Router();
    $router->endpoint('/endpoints', TestEndpoint::class, 'id')->name('albums')->add();
...
test('Endpoint default renderer', function () {
    $router = new Router();
    $router->endpoint('/endpoint', TestEndpoint::class, 'id')->add();
...
test('Endpoint set renderer', function () {
    $router = new Router();
    $router->endpoint('/endpoint', TestEndpoint::class, 'id')->render('text', 1, 'test')->add();
    $route = $router->match($this->request(method: 'GET', url: '/endpoint'));
    $rendererConfig = $route->getRenderer();
